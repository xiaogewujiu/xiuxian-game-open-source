...
namespace XXX.Entity
{
    ...
    /// 文字图鉴系列实体
    /// </summary>
    [SugarTable("text_collection_series")]
    public class TextCollectionSeriesEntity
    {
    ...
    /// 文字图鉴项实体
    /// </summary>
    [SugarTable("text_collection_item")]
    public class TextCollectionItemEntity
    {
        ...
        [SugarColumn(ColumnDescription = "汉字内容", Length = 10)]
        public string Character { get; set; } = string.Empty;

        [SugarColumn(ColumnDescription = "槽位序号")]
    ...
    /// 文字图鉴属性加成实体
    /// </summary>
    [SugarTable("text_collection_bonus")]
    public class TextCollectionBonusEntity
    {
