...
namespace XXX.Quest
{
    ...
    public class QuestReward
    {
        ...
        {
            return Exp > 0 || Gold > 0 || SpiritStone > 0 ||
        ...
        public QuestRewardResult GrantRewards(UserEntity player, InventoryManager inventory)
        {
            ...
            try
            {
                ...
                if (Gold > 0)
                {
                    if (PlayerManager.AddGold(player, Gold, "任务奖励"))
                    {
                ...
                if (SpiritStone > 0)
                {
                    if (PlayerManager.AddSpiritStone(player, SpiritStone, "任务奖励"))
                    {
